...
@section('title', 'Chỉnh sửa tài khoản thanh toán')
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header border-bottom">
                                ...
                                <p class="text-muted mb-0 mt-1">Cập nhật thông tin chi tiết cho tài khoản thanh toán</p>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.payments.update', $payment) }}" method="POST" enctype="multipart/form-data" id="editPaymentForm">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                       id="name" name="name" value="{{ old('name', $payment->name) }}" required
                                                       placeholder="VD: ACB - Ngân hàng Á Châu">
                                                @error('name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('min') is-invalid @enderror" 
                                                       id="min" name="min" value="{{ old('min', $payment->min) }}" required
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('max') is-invalid @enderror" 
                                                       id="max" name="max" value="{{ old('max', $payment->max) }}" required
                                                       min="0" step="0.0001" placeholder="0.0000">
                                                @error('max')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="mb-2">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="image_method" id="upload_method" value="upload" 
                                                               {{ !filter_var($payment->image ?? '', FILTER_VALIDATE_URL) ? 'checked' : '' }}>
                                                ...
                                                <!-- Upload File Input -->
                                                <div id="upload_section" {{ filter_var($payment->image ?? '', FILTER_VALIDATE_URL) ? 'style=display:none;' : '' }}>
                                                ...
                                                <!-- Link Input -->
                                                <div id="link_section" {{ !filter_var($payment->image ?? '', FILTER_VALIDATE_URL) ? 'style=display:none;' : '' }}>
                                                    <input type="url" class="form-control @error('image_input') is-invalid @enderror" 
                                                           id="image_input" name="image_input" 
                                                           value="{{ filter_var($payment->image ?? '', FILTER_VALIDATE_URL) ? $payment->image : old('image_input') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div id="bonusRules" class="border rounded p-3">
                                                    <!-- Bonus rules will be populated here -->
                                                </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('note') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Nhập ghi chú (tùy chọn)">{{ old('note', $payment->note) }}</textarea>
                                        @error('note')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!-- Payment Method Preview -->
                                <div id="paymentMethodPreview" class="mb-3">
                                    <div class="alert alert-info">
                                        <div class="d-flex align-items-center">
                                            <i class="bx bx-credit-card me-2"></i>
                                            <div>
                                                <strong>Phương thức thanh toán:</strong>
                                                <div id="selectedMethodName" class="text-primary">{{ $payment->paymentMethod->name ?? 'Chưa chọn' }}</div>
                                                <div id="selectedMethodType" class="text-muted small">Loại: {{ ucfirst(str_replace('_', ' ', $payment->payment_type)) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @if($payment->image_url)
                                    <div class="text-center mb-3">
                                        <div class="border rounded p-3">
                                            <img src="{{ $payment->image_url }}" alt="Current Image" class="img-fluid rounded"
                                ...
                                <div class="text-center">
                                    <div id="imagePreview" style="display: none;">
                                        <img id="previewImg" src="" alt="Preview" class="img-fluid rounded"
                                             style="max-height: 200px; max-width: 200px; object-fit: cover;">
                                        <p class="text-muted small mt-2">Hình ảnh mới</p>
                                    </div>
                                    @if(!$payment->image_url)
...
@push('scripts')
    <script>
        // Payment method configurations (same as create view)
            ...
            'payeer': {
                ...
                example: {
                    ...
                    merchant_id: 'P123456789'
                        ...
                        type: 'text',
                        required: false,
                        placeholder: 'VD: ACB_SIGNATURE_KEY'
                    },
                    {
                        name: 'webhook_url',
                        label: 'Webhook URL',
                ...
                example: {
                    ...
                    account_number: '123456789',
                    signature: 'ACB_SIGNATURE_KEY',
                    webhook_url: 'https://example.com/webhook/acb'
                }
            },
            'binance': {
                type: 'binance',
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        type: 'url',
                        required: false,
                        placeholder: 'https://example.com/webhook/binance'
                    }
                ],
                example: {
                    binance_id: 'binance_user_123',
                    api_key: 'BINANCE_API_KEY_EXAMPLE',
                    secret_key: 'BINANCE_SECRET_KEY_EXAMPLE',
                    webhook_url: 'https://example.com/webhook/binance'
                }
            },
            'payeer': {
                type: 'payeer',
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        type: 'url',
                        required: true,
                        placeholder: 'https://example.com/payment/status'
                    }
                ],
                example: {
                    merchant_id: 'P123456789',
        ...
        /**
         * Determine payment type from method name (case insensitive)
         */
        function getPaymentTypeFromMethodName(methodName) {
            const name = methodName.toLowerCase().trim();
            
            // Check for ACB or Vietnamese banks
        ...
        $(document).ready(function() {
            // Initialize bonus rules with existing data
            initializeBonusRules();

            // Initialize image preview if image exists
            @if($payment->image)
                @if(filter_var($payment->image, FILTER_VALIDATE_URL))
                    // It's a URL
                    $('#previewImg').attr('src', '{{ $payment->image }}');
                    $('#imagePreview').show();
                    $('#noImagePreview').hide();
                @else
                    // It's a file
                    $('#previewImg').attr('src', '{{ asset('storage/payments/' . $payment->image) }}');
                    $('#imagePreview').show();
                    $('#noImagePreview').hide();
                @endif
            @endif

            // Load initial dynamic fields based on current payment method
            const currentSelectedOption = $('#payment_method_id option:selected');
            if (currentSelectedOption.val()) {
                const currentMethodType = currentSelectedOption.data('type') || 'other';
                loadDynamicFields(currentMethodType, true); // true = populate with existing data
            }
            ...
            $('#editPaymentForm').on('submit', function(e) {
                ...
                submitBtn.prop('disabled', true).html(
                    '<i class="bx bx-loader-alt bx-spin me-1"></i>Đang cập nhật...'
                );
            });
        ...
        function loadDynamicFields(methodType, populateExisting = false) {
                        ...
                        <div class="alert alert-${config.color} alert-dismissible border-0 mb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0 small">Cập nhật thông tin cấu hình cho phương thức thanh toán</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            config.fields.forEach((field, index) => {
                ...
                // Get existing value if populating
                let existingValue = '';
                if (populateExisting) {
                    const paymentData = @json($payment->toArray());
                    existingValue = paymentData[field.name] || '';
                }
        ...
        function getPaymentTypeLabel(type) {
            const typeLabels = {
                'vietnamese_bank': 'Ngân hàng Việt Nam',
                'binance': 'Binance',
                'payeer': 'Payeer',
                'other': 'Khác'
            };
...
@push('scripts')
    <script>
        // Bonus Rules Management for Edit View
        let bonusRuleIndex = 0;

        function initializeBonusRules() {
            // Load existing bonus data
            const existingBonus = @json($payment->bonus ?? []);
            
            // Clear existing rules
            $('#bonusRules').empty();
            
            if (existingBonus && existingBonus.length > 0) {
                existingBonus.forEach((rule, index) => {
                    addBonusRuleWithData(rule.min_amount || 0, rule.bonus_percent || 0);
                });
            } else {
                // Add one empty rule if no existing data
                addBonusRule();
            }
        ...
        function addBonusRule() {
            addBonusRuleWithData(0, 0);
        }

        function addBonusRuleWithData(amount = 0, percent = 0) {
            bonusRuleIndex++;
            const ruleHtml = `

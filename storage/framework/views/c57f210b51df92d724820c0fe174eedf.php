        ...
        <div class="card shadow">
            <div class="card-body p-5">
                <div class="mb-5 div-filter-status">
                    ...
                    ?>
                    <?php $__currentLoopData = $statusBtns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="javascript:;"
                            class="btn btn-sm btn-outline <?php echo e($info[1]); ?> px-3 py-1 me-3 <?php echo e($activeStatus === ($statusPathMap[$val] ?? '') ? 'active' : ''); ?>"
                            onclick="_product_orders.on.click.filterStatus('<?php echo e($val ?: 'All'); ?>')">
                            <span data-lang="<?php echo e($info[2]); ?>"><?php echo e($info[0]); ?></span>
                        </a>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-2 col-md-6 col-6">
                        <input type="text"
                            ...
                            data-col-name="provider_product_order_id" value="<?php echo e(request('provider_id')); ?>">
                    </div>
                    <div class="col-lg-3 col-md-6 col-7">
                        <select class="form-select form-select-solid form-select-sm datatable-input"
                            ...
                            <option value="" <?php echo e(empty(request('product_id')) ? 'selected' : ''); ?>></option>
                    ...
                    <table class="table fs-7 gy-1 gs-3 table-orders custom-table" style="width:100%">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr data-note="<?php echo e(addslashes($order->note ?? '')); ?>">
                                    ...
                                    <td class="pt-2">
                                        ...
                                        <?php else: ?>
                                            <button type="button"
                                                class="btn <?php echo e($btnClass); ?> btn-sm fs-7 py-1 px-2 action-<?php echo e($order->id); ?>"
                                                data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                                data-lang="status::<?php echo e($order->status); ?>"
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4"
                                                data-kt-menu="true">
                                                <?php if(in_array($order->status, ['Pending', 'Awaiting', 'Manual', 'Failed'])): ?>
                                                    <div class="menu-item px-3">
                                                        <a href="javascript:;"
                                                            onclick="_product_orders.on.click.changeStatus('In progress', '<?php echo e($order->id); ?>')"
                                                            class="menu-link px-3" data-lang="status::In progress">Đang
                                                            chạy</a>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(!in_array($order->status, ['Completed', 'Partial'])): ?>
                                                    <div class="menu-item px-3">
                                                        <a href="javascript:;"
                                                            onclick="_product_orders.on.click.showModalCompleted('<?php echo e($order->id); ?>')"
                                                ...
                                                <?php if($order->status === 'Completed'): ?>
                                                    <div class="menu-item px-3">
                                                        <a href="javascript:;"
                                                            onclick="_product_orders.on.click.changeStatus('Canceled', '<?php echo e($order->id); ?>')"
                                                            class="menu-link px-3" data-lang="status::Canceled">Hủy</a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                        <a href="javascript:;"
                                                            onclick="_product_orders.on.click.changeStatus('Partial', '<?php echo e($order->id); ?>')"
                                                            class="menu-link px-3" data-lang="status::Partial">Hoàn tiền một
                                                            phần</a>
                                                    </div>
                                                <?php elseif(!in_array($order->status, ['Partial'])): ?>
                                                    <div class="menu-item px-3">
                                                        <a href="javascript:;"
                                                            onclick="_product_orders.on.click.changeStatus('Canceled', '<?php echo e($order->id); ?>')"
                                                            class="menu-link px-3" data-lang="status::Canceled">Hủy</a>
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="javascript:;"
                                                        onclick="_product_orders.on.click.addNote('<?php echo e($order->id); ?>')"
                                            ...
                                            <p class="mb-0 mt-1 fs-7">
                                                <?php if($order->note): ?>
                                                    <a href="javascript:;"
                                                        onclick="_product_orders.on.click.result(<?php echo e($order->id); ?>)"
                                    ...
                                    <td>
                                        ...
                                        <?php if($order->provider_product_order_id): ?>
                                            <p class="m-0 fs-8 text-gray-600"><?php echo e($order->provider_product_order_id); ?></p>
                                        <?php endif; ?>
                                        <p class="m-0 fs-8 text-gray-600"><?php echo e($order->created_at->format('Y-m-d H:i:s')); ?>

                                        </p>
                                        <p class="m-0 fs-8 text-gray-600"><?php echo e($order->updated_at->format('Y-m-d H:i:s')); ?>
                                    ...
                                    <td>
                                        <p class="m-0">
                                            ...
                                            <span class="fw-bold"><?php echo e(number_format($order->amount)); ?></span>
                                            (<?php echo e(number_format($order->charge)); ?>)
                                        </p>
                                        <p class="m-0">
                                    ...
                                    <td>
                                        <p class="m-0">
                                            <?php echo e($order->product ? $order->product->id . ' - ' . $order->product->name : 'N/A'); ?>

                                        </p>
                                        <p class="m-0 fs-8">
                                            <a class="text-gray-700 ls-1" target="_blank"
                                                href="/admin/accounts/<?php echo e($order->user->username ?? ''); ?>">
                                                <?php echo e($order->user->username ?? 'N/A'); ?>

                                            </a>
                                        </p>
                                        <p class="m-0 fs-8">
                                            <a href="javascript:;"
                                                onclick="_product_orders.on.click.require(<?php echo e($order->id); ?>)"
                ...
                <div class="row mt-3">
                    <div class="col-md-5 d-flex align-items-center">
                        <div class="text-muted fs-8">
                            ...
                            <?php echo e($orders->firstItem() ?? 0); ?> - <?php echo e($orders->lastItem() ?? 0); ?> /
...
<?php echo $__env->make('adminpanel.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/adminpanel/product_orders/index.blade.php ENDPATH**/ ?>
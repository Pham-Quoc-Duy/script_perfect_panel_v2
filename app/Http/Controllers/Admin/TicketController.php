...
class TicketController extends Controller
{
    ...
    public function ticketList(): View
    {
        $ticketOrders = DB::table('orders')
            ...
            ->whereIn('orders.ticket', ['speedup', 'refill', 'cancel'])
            ->select(
                'orders.id',
                'orders.service_id',
                'orders.ticket',
        ...
        $stats = [
            'waiting'    => DB::table('orders')->whereIn('ticket', ['speedup', 'refill', 'cancel'])->count(),
            'processing' => DB::table('orders')->whereIn('ticket', ['speedup', 'refill', 'cancel'])->where('status', 'processing')->count(),
        ];

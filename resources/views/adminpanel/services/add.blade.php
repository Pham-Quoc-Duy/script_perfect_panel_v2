...
@section('content')
    <div class="content flex-row-fluid" id="kt_content" data-select2-id="select2-data-kt_content"><span
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="row div-type-api-container" style="display: none;">
                            ...
                            <div class="col-lg-9">
                                <div class="mb-5 div-type-api">
                                    <div class="mb-5 div-service-select" style="display: none;">
                                        ...
                                        <select class="form-select form-select-solid sl-provider-sid" data-kt-select2="true"
                                         ...
                                         <input type="hidden" class="ipt-service-api" value="">
                                    </div>
                                </div>
                            ...
                            <div class="mb-5">
                                <label class="required form-label"><span data-lang="Retail Rate">Giá bán lẻ</span> <span
                                        class="show-api" style=""> | <span class="data-api"><span
                                                class="text-danger" id="rate-original-display">0</span></span></span></label>
                                <div class="input-group input-group-solid">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $markupConfig['markup_retail'] ?? 110 }}" onkeyup="price_percent(this.value, 0)"
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $markupConfig['markup_agent'] ?? 108 }}" onkeyup="price_percent(this.value, 1)"
                                        data-inputmask="'mask': '9{1,4}.9{1,2}', 'greedy': false, 'placeholder': '0'"
                            ...
                            <div class="">
                                ...
                                <div class="input-group input-group-solid">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $markupConfig['markup_distributor'] ?? 105 }}" onkeyup="price_percent(this.value, 2)"
                                        data-inputmask="'mask': '9{1,4}.9{1,2}', 'greedy': false, 'placeholder': '0'"
                    ...
                    <div class="col-lg-4 col-sm-6 ">
                                ...
                                <div class="">
                                    <label class="required form-label"><span data-lang="Min/Max">SL đặt hàng: Tối
                                            thiếu-Tối đa</span> <span class="show-api" style=""> | <span
                                                class="data-api"><span class="text-danger" id="min-display">100</span> - <span
                                                    class="text-danger" id="max-display">100000</span></span></span></label>
                        ...
                        <div class="">
                            <label class="required form-label"><span data-lang="Order Type">Kiểu dịch vụ</span> <span
                                    class="show-api" style=""> | <span class="data-api"><span
                                            class="text-danger" id="type-display">Default</span></span></span></label>
                            <select class="form-select form-select-solid sl-service-type"
                                ...
                                <option value="Mentions with Hashtags">Mentions with Hashtags</option>
                                <option value="Mentions User Followers">Mentions User Followers</option>
                                <option value="Mentions Custom List">Mentions Custom List</option>
                                <option value="Mentions Hashtag">Mentions Hashtag</option>
                                <option value="Mentions Media Likers">Mentions Media Likers</option>
                                <option value="Comment Likes">Comment Likes</option>
                                <option value="Invites from Groups">Invites from Groups</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 ">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <label class="form-check-label required"><span data-lang="">Yêu cầu bảo hành</span>
                                        <span class="show-api" style=""> | <span class="data-api"><span
                                                    class="text-danger">Không</span></span></span></label>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class="border border-2 rounded p-2">
        ...
        <div class="card shadow-sm">
            <div class="card-body p-0">
                ...
                <input type="hidden" id="service-description-content" name="description" value="">
            </div>
        </div>
        ...
        @php $avgTimeValue = 0; $avgTimeDisplay = "0s"; @endphp
        <div class="row g-5 card-avg-time mt-0" style="display: none;">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    <span class="input-group-text bg-text text-avg-time">0s</span>
                                    <input type="text" class="form-control ipt-service-avg-time"
                                        data-inputmask="'mask': '9', 'repeat': 9, 'greedy' : false" value="0"
        ...
        <div class="row g-5 mt-6">
            <div class="col-12">
                <button type="button" class="btn btn-primary w-100" id="addServiceBtn" onclick="store()"
                    data-lang="button::Add">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Xử lý khi thay đổi provider - chỉ lưu lại, chưa load
            function onProviderChange(providerId) {
                const serviceSelectDiv = document.querySelector('.div-service-select');

                if (!providerId || providerId === '0') {
                    window.pendingProviderId = null;
                    window.providerServicesLoaded = false;
                    // Ẩn select dịch vụ
                    if (serviceSelectDiv) serviceSelectDiv.style.display = 'none';
                    if (serviceSelect) {
                ...
                // Lưu provider id, reset flag, hiện select dịch vụ
                window.pendingProviderId = providerId;
                window.providerServicesLoaded = false;
                if (serviceSelectDiv) serviceSelectDiv.style.display = '';
                if (serviceSelect) {
                    serviceSelect.innerHTML = '<option value="0">Chọn</option>';
                    if (window.$ && $(serviceSelect).data('select2')) {
                        $(serviceSelect).trigger('change');
            ...
            // Select2 select event (chính)
            if (window.$) {
                $(providerSelect).on('select2:select', function(e) {
                    onProviderChange(e.params.data.id);
                });
            }

            // Khi user click/open select dịch vụ thì mới load
        ...
        function loadProviderServices(providerId, showLoader = true, autoSelect = false) {
            ...
            // Disable select, giữ option "Chọn" trong khi đang load
            ...
            return fetch(url, {
                ...
                .then((data) => {
                    if (data.success && data.services && Array.isArray(data.services)) {
                        // Thêm option "Chọn" đầu tiên rồi mới thêm services
                        serviceSelect.innerHTML = '<option value="0">Chọn</option>';
        ...
        window.store = function() {
            ...
            if (connectionType === 'api') {
                ...
                if (providerSelect && providerSelect.value && providerSelect.value !== '0') {
                    ...
                    // Lấy provider_name từ option text
                    const selectedProviderOption = providerSelect.options[providerSelect.selectedIndex];
                    if (selectedProviderOption) {
                        formData.append('provider_name', selectedProviderOption.text.trim());
                    }
                }
                if (serviceSelect && serviceSelect.value && serviceSelect.value !== '0') {
                    formData.append('service_api', serviceSelect.value);
                    formData.append('provider_service_id', serviceSelect.value);
                }
            }

            const rateInput = document.querySelector('.ipt-service-oprice');
            if (rateInput && rateInput.value) formData.append('rate_original', rateInput.value);

            // Lấy category và image của category
            const categorySelect = document.querySelector('.sl-category');
            if (categorySelect && categorySelect.value) {
                formData.append('category_id', categorySelect.value);
                const selectedCategoryOption = categorySelect.options[categorySelect.selectedIndex];
                if (selectedCategoryOption) {
                    const categoryImage = selectedCategoryOption.getAttribute('data-icon');
                    if (categoryImage) formData.append('image', categoryImage);
                }
            }

            const nameInput = document.querySelector('.ipt-service-name');
            if (nameInput && nameInput.value) formData.append('name[en]', nameInput.value);

            const translatedContainer = document.getElementById('div-translated-name');
            if (translatedContainer) {
                translatedContainer.querySelectorAll('input.ipt-service-translated-name').forEach(input => {
                    const lang = input.getAttribute('data-lang');
                    if (lang && input.value.trim()) formData.append(`name[${lang}]`, input.value);
                });
            }

            [['rate_retail', '.ipt-service-price'], ['rate_agent', '.ipt-service-price-1'],
             ['rate_distributor', '.ipt-service-price-2'], ['rate_retail_up', '.ipt-service-price-percent'],
             ['rate_agent_up', '.ipt-service-price-1-percent'], ['rate_distributor_up', '.ipt-service-price-2-percent']
            ].forEach(([field, sel]) => {
            ...
            const tlimit = document.querySelector('.ipt-service-tlimit');
            const limit = document.querySelector('.ipt-service-limit');
            if (tlimit && tlimit.value) formData.append('total_limit', tlimit.value);
            if (limit && limit.value) formData.append('limit', limit.value);

            const statusCheckbox = document.querySelector('.cb-service-status');
            formData.append('status', statusCheckbox && statusCheckbox.checked ? '1' : '0');
            ...
            if (refillCheckbox) formData.append('refill', refillCheckbox.checked ? '1' : '0');
            if (cancelCheckbox) formData.append('cancel', cancelCheckbox.checked ? '1' : '0');

            const descInput = document.getElementById('service-description-content');
            ...
            if (typeSelect && typeSelect.value) formData.append('type_service', typeSelect.value);

            // average_time
            const avgTimeInput = document.querySelector('.ipt-service-avg-time');
            if (avgTimeInput && avgTimeInput.value) formData.append('average_time', avgTimeInput.value);

            // attributes từ sl-features (dùng Select2 nếu có)
            const attributesSelect = document.querySelector('.sl-features');
            if (attributesSelect) {
                let selectedAttributes = [];
                if (window.$ && $(attributesSelect).data('select2')) {
                    ...
                    selectedAttributes = Array.from(attributesSelect.selectedOptions).map(o => o.value);
                }
                selectedAttributes = selectedAttributes.filter(a => a && a.trim() !== '');
            ...
            .then(data => {
                if (data.success) {
                    showToast(typeof data.success === 'string' ? data.success : 'Thêm dịch vụ thành công!', 'success');
                    setTimeout(() => window.location.href = '/admin/services', 1500);
                } else {
                    if (typeof hideFullScreenLoader === 'function') hideFullScreenLoader();
                    showToast(data.message || 'Lỗi khi thêm dịch vụ', 'error');

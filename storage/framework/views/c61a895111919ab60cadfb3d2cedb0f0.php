...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content flex-column-fluid" id="kt_content">
        <!--begin::Toolbar-->
        <?php echo $__env->make('clients.theme-4.layouts.toolbar', ['toolbarTitle' => 'New order'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <!--end::Toolbar-->
        <!--begin::Post-->
        <div class="post" id="kt_post">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select id="sl-quick-search" class="form-select form-select-solid" style="display:none">
                            <option value=""></option>
                            <?php $__currentLoopData = $data['services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($svc['id']); ?>" data-rate="<?php echo e($svc['rate_formatted']); ?>"
                                    data-content="<div><span class=&quot;fw-bolder me-1&quot;><?php echo e($svc['id']); ?></span> - <?php echo e(e($svc['name'])); ?> - <span class=&quot;text-primary fw-bolder ms-1&quot;><?php echo e(e($svc['rate_formatted'])); ?></span></div>">
                                    <?php echo e($svc['id']); ?> - <?php echo e($svc['name']); ?> - <?php echo e($svc['rate_formatted']); ?></option>
                        ...
                        <div class="col-lg-5">
                            <div class="mb-3">
                                ...
                                <select id="sl-platform" class="form-select form-select-solid">
                                    ...
                                    <?php $__currentLoopData = $data['platforms']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($p->image && (str_contains($p->image, '/') || str_contains($p->image, '.'))): ?>
                                            <option value="<?php echo e($p->id); ?>"
                                                data-content="&lt;img src=&quot;<?php echo e($p->image); ?>&quot; class=&quot;w-15px h-15px me-1&quot; /&gt; <?php echo e($p->name); ?>"
                                                data-lang=""><?php echo e($p->name); ?></option>
                                        <?php elseif($p->image): ?>
                                            <option value="<?php echo e($p->id); ?>"
                                                data-content="&lt;i class=&quot;<?php echo e($p->image); ?>&quot;&gt;&lt;/i&gt; <?php echo e($p->name); ?>"
                                                data-lang=""><?php echo e($p->name); ?></option>
                                        <?php else: ?>
                                            <option value="<?php echo e($p->id); ?>" data-content="<?php echo e($p->name); ?>"
                                                data-lang=""><?php echo e($p->name); ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
            ...
            <script>
                var LABEL_FEATURES = {
                    ...
                    })(<?php echo json_encode($data['services'], 15, 512) ?>, <?php echo json_encode($data['categories'], 15, 512) ?>);
            </script>
        </div>
        <!--end::Post-->
    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var allCategories = <?php echo json_encode($data['categories'], 15, 512) ?>;
            ...
            $('#sl-quick-search').css('display', '').select2({
                placeholder: '<?php echo e($langData["addfunds.please_select"] ?? "Please choose"); ?>',
                allowClear: false,
                width: '100%',
                ...
                templateSelection: function(o) {
                    ...
                    return '<?php echo e($langData["addfunds.please_select"] ?? "Please choose"); ?>';
                }
            });
            ...
            (function() {
                ...
                <?php if(!empty($data['selectedService'])): ?>
                // Có ?service= trong URL — load đúng platform > category > service
                var _sel = <?php echo json_encode($data['selectedService'], 15, 512) ?>;
                if (_sel && _sel.id) {
                    setTimeout(function() {
                ...
                on: {
                    ...
                    click: {
                        ...
                        order: function() {
                            ...
                            fetch('<?php echo e(route("clients.orders.store")); ?>', {
                                method: 'POST',
                                headers: {
...
<?php echo $__env->make('clients.theme-4.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/clients/theme-4/new.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <base href="">
    <title id="page-title" data-lang=""><?php echo $__env->yieldContent('title'); ?> | <?php echo e($config->title ?? getDomain()); ?></title>
    <meta charset="utf-8">
    ...
    <link href="<?php echo e(asset('adminpanel/plugins/custom/fullcalendar/fullcalendar.bundle.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('adminpanel/plugins/custom/datatables/datatables.bundle.css')); ?>" rel="stylesheet" type="text/css">
    <!--end::Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
    <link href="<?php echo e(asset('adminpanel/plugins/global/plugins.bundle.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('adminpanel/css/style.bundle.css')); ?>" rel="stylesheet" type="text/css">
    <!--end::Global Stylesheets Bundle-->
    <link href="https://cdn.whoispanel.com/flags/css/flag-icons.min.css" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('adminpanel/assets/style.css')); ?>" rel="stylesheet" type="text/css">
...
<body id="kt_body" class="header-extended header-fixed header-tablet-and-mobile-fixed" style="">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                <!--::Header-->
                <?php echo $__env->make('adminpanel.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php $pageTitle = $__env->yieldContent('title', ''); ?>
                <?php echo $__env->make('adminpanel.layouts.toolbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <!--::Toolbar-->
                ...
                <!--end::Container-->
                <!--begin::Footer-->
                <?php echo $__env->make('adminpanel.layouts.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script src="<?php echo e(asset('adminpanel/plugins/global/plugins.bundle.js')); ?>"></script>
    <script src="<?php echo e(asset('adminpanel/js/scripts.bundle.js')); ?>"></script>
    <!--end::Global Javascript Bundle-->
    <!--begin::Vendors Javascript(used for this page only)-->
    <script src="<?php echo e(asset('adminpanel/plugins/custom/datatables/datatables.bundle.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('adminpanel/js/services/quill-editor.js')); ?>"></script>
    <script src="<?php echo e(asset('adminpanel/assets/app.js')); ?>?v=14.9.0.6"></script>
    ...
    <script>
        ...
        // app_admin: alias → app.on.click.changeLanguage (logic in app.js)
        var app_admin = { on: { click: { changeLanguage: function(l) { app.on.click.changeLanguage(l); } } } };
...
<?php /**PATH C:\xampp\htdocs\resources\views/adminpanel/layouts/app.blade.php ENDPATH**/ ?>
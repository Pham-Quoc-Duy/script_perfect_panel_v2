...
@section('title', 'Chỉnh sửa Ticket Subject')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Chỉnh sửa Ticket Subject</h4>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="card-title mb-0">Chỉnh sửa: {{ $ticketSubject->category }}{{ $ticketSubject->subcategory ? ' - ' . $ticketSubject->subcategory : '' }}</h4>
                        ...
                        <form action="{{ route('admin.ticket-subjects.update', $ticketSubject) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                @if($errors->any())
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('category') is-invalid @enderror" 
                                                   id="category" name="category" value="{{ old('category', $ticketSubject->category) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('subcategory') is-invalid @enderror" 
                                                   id="subcategory" name="subcategory" value="{{ old('subcategory', $ticketSubject->subcategory) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                                ...
                                                <option value="1" {{ old('status', $ticketSubject->status) == 1 ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ old('status', $ticketSubject->status) == 0 ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $ticketSubject->sort_order) }}" 
                                                   min="0" placeholder="0">
                                            @error('sort_order')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="show_message_only" 
                                               name="show_message_only" value="1" {{ old('show_message_only', $ticketSubject->show_message_only) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('required_fields') is-invalid @enderror" 
                                              ...
                                              placeholder='[{"id":"order_id","name":"Order ID","type":"text","required":true,"placeholder":"Enter order ID"}]'>{{ old('required_fields') ? (is_array(old('required_fields')) ? json_encode(old('required_fields')) : old('required_fields')) : ($ticketSubject->required_fields ? json_encode($ticketSubject->required_fields) : '') }}</textarea>
                                    <div class="form-text">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="text-center">
                                                    ...
                                                    <h5 class="font-size-16 mb-1">{{ $ticketSubject->tickets()->count() }}</h5>
                                            ...
                                            <div class="col-md-3">
                                                <div class="text-center">
                                                    ...
                                                    <h5 class="font-size-16 mb-1">{{ $ticketSubject->tickets()->where('status', 'open')->count() }}</h5>
                                            ...
                                            <div class="col-md-3">
                                                <div class="text-center">
                                                    ...
                                                    <h5 class="font-size-16 mb-1">{{ $ticketSubject->tickets()->where('status', 'answered')->count() }}</h5>
                                            ...
                                            <div class="col-md-3">
                                                <div class="text-center">
                                                    ...
                                                    <h5 class="font-size-16 mb-1">{{ $ticketSubject->tickets()->where('status', 'closed')->count() }}</h5>

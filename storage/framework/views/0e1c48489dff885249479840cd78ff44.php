                ...
                <div class="d-flex align-items-center ms-lg-5" id="kt_header_user_menu_toggle">
                    <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 ps-2 pe-2 me-n2"
                        ...
                        <div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
                            ...
                            ?>
                            <span class="fs-8 fw-bold lh-1 ls-1 mb-1"><?php echo e(auth()->user()->username); ?></span>
                            <span class="opacity-75 fs-8 fw-semibold lh-1" data-lang="<?php echo e($levelKey); ?>"><?php echo e($levelText); ?></span>
                        </div>
                        <div class="symbol symbol-30px symbol-md-40px">
                            <img src="https://cdn.whoispanel.com/dashboard/5/media/avatars/300-1.jpg" alt="<?php echo e(auth()->user()->username); ?>">
                        </div>
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                <div class="symbol symbol-50px me-5">
                                    <img alt="<?php echo e(auth()->user()->username); ?>" src="https://cdn.whoispanel.com/dashboard/5/media/avatars/300-1.jpg">
                                </div>
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        <?php echo e(auth()->user()->username); ?>

                                        <span class="badge <?php echo e($badgeClass); ?> fw-bold fs-8 px-2 py-1 ms-2" data-lang="<?php echo e($levelKey); ?>"><?php echo e($levelText); ?></span>
                                    </div>
                                    <span class="fw-semibold text-muted fs-7"><?php echo e(auth()->user()->email); ?></span>
                                </div>
                            </div>
                        </div>
...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-stretch container-xxl">
    <?php echo $__env->make('clients.theme-4.layouts.aside', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <div class="wrapper d-flex flex-column flex-row-fluid mt-5 mt-lg-10" id="kt_wrapper">
    <?php echo $__env->yieldContent('content'); ?>
<?php /**PATH C:\xampp\htdocs\resources\views/clients/theme-4/layouts/header.blade.php ENDPATH**/ ?>
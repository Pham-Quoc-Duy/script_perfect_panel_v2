...
@section('content')
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="d-flex flex-wrap flex-stack mb-6">
            <h3 class="fw-bold my-2" data-lang="Direct message">Tin nhắn trực tiếp</h3>
            <div class="d-flex flex-wrap my-2">
                <button class="btn btn-primary btn-sm" data-lang="button::Update"
                    onclick="_settings.on.click.updateSupport(document.querySelector('.ipt-contact-facebook').value.trim(), document.querySelector('.ipt-contact-skype').value.trim(), document.querySelector('.ipt-contact-telegram').value.trim(), document.querySelector('.ipt-contact-whatsapp').value.trim(), document.querySelector('.ipt-contact-phone').value.trim(), document.querySelector('.cb-direct-message-chatbox').checked)">Cập
                    nhật</button>
            </div>
        </div>
        <div class="row g-6">
                    ...
                    <div class="card-body">
                        <div class="mb-5">
                            <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                <input class="form-check-input cb-direct-message-chatbox" type="checkbox" checked="">
                                <label class="form-check-label" data-lang="Show direct message chatbox">Hiển thị chatbox tin nhắn trực tiếp</label>
                            </div>
                        </div>
                        <div class="mb-5">
                            <label class="form-label">Facebook</label>
                            <div class="input-group input-group-solid">
                                <span class="input-group-text"><i class="fa-brands fa-facebook fs-2"></i></span>
                                <input type="text" class="form-control ipt-contact-facebook"
                                    value="https://www.facebook.com/pq.duy.2024">
                            </div>
                        </div>
                        <div class="mb-5">
                            <label class="form-label">Skype</label>
                            <div class="input-group input-group-solid">
                                <span class="input-group-text"><i class="fa-brands fa-skype fs-2"></i></span>
                                <input type="text" class="form-control ipt-contact-skype" value="">
                            </div>
                        </div>
                        <div class="mb-5">
                            <label class="form-label">Telegram</label>
                            <div class="input-group input-group-solid">
                                <span class="input-group-text"><i class="fa-brands fa-telegram fs-2"></i></span>
                                <input type="text" class="form-control ipt-contact-telegram"
                                    value="https://t.me/qtv_smm">
                            </div>
                        </div>
                        <div class="mb-5">
                            <label class="form-label">Whatsapp</label>
                            <div class="input-group input-group-solid">
                                <span class="input-group-text"><i class="fa-brands fa-whatsapp fs-2"></i></span>
                                <input type="text" class="form-control ipt-contact-whatsapp"
                                    value="https://wa.me/+84334713016">
                            </div>
                        </div>
                        <div class="mb-5">
                            <label class="form-label">Phone</label>
                            <div class="input-group input-group-solid">
                                <span class="input-group-text"><i class="fa-solid fa-phone fs-4"></i></span>
                                <input type="text" class="form-control ipt-contact-phone" value="0334713016">
                            </div>
                        </div>
                        <div class="mb-5">
                            <label class="form-label" data-lang="Other contact">Liên hệ khác</label>
                            <div role="toolbar" class="ql-toolbar ql-snow"><span class="ql-formats"><button
                                        type="button" class="ql-bold" aria-pressed="false" aria-label="bold"><svg
                                            viewBox="0 0 18 18">
                                        ...
                                        aria-label="italic"><svg viewBox="0 0 18 18">
                                            ...
                                            <line class="ql-stroke" x1="8" x2="10" y1="14"
                                                y2="4"></line>
                                        </svg></button><button type="button" class="ql-underline" aria-pressed="false"
                                        aria-label="underline"><svg viewBox="0 0 18 18">
                                            <path class="ql-stroke"
                                        ...
                                        </svg></button><button type="button" class="ql-strike" aria-pressed="false"
                                        aria-label="strike"><svg viewBox="0 0 18 18">
                                        ...
                                        class="ql-blockquote" aria-pressed="false" aria-label="blockquote"><svg
                                            viewBox="0 0 18 18">
                                        ...
                                        </svg></button><button type="button" class="ql-code-block" aria-pressed="false"
                                        ...
                                        class="ql-list" aria-pressed="false" value="ordered"
                                        aria-label="list: ordered"><svg viewBox="0 0 18 18">
                                        ...
                                        </svg></button><button type="button" class="ql-list" aria-pressed="false"
                                        value="bullet" aria-label="list: bullet"><svg viewBox="0 0 18 18">
                                            ...
                                            <line class="ql-stroke" x1="3" x2="3" y1="14"
                                                y2="14"></line>
                                        </svg></button><button type="button" class="ql-align" aria-pressed="false"
                                        aria-label="align"><svg viewBox="0 0 18 18">
                                            <line class="ql-stroke" x1="3" x2="15" y1="9"
                                                y2="9"></line>
                                            <line class="ql-stroke" x1="3" x2="13" y1="14"
                                                y2="14"></line>
                                            <line class="ql-stroke" x1="3" x2="9" y1="4"
                                                y2="4"></line>
                                        ...
                                        class="ql-color ql-picker ql-color-picker"><span class="ql-picker-label"
                                            ...
                                            tabindex="-1" id="ql-picker-options-0"><span tabindex="0" role="button"
                                                class="ql-picker-item ql-primary"></span><span tabindex="0"
                                                ...
                                                style="background-color: rgb(255, 153, 0);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item ql-primary" data-value="#ffff00"
                                                style="background-color: rgb(255, 255, 0);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item ql-primary" data-value="#008a00"
                                                style="background-color: rgb(0, 138, 0);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item ql-primary" data-value="#0066cc"
                                                style="background-color: rgb(0, 102, 204);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item ql-primary" data-value="#9933ff"
                                                style="background-color: rgb(153, 51, 255);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item" data-value="#ffffff"
                                                ...
                                                style="background-color: rgb(178, 107, 0);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item" data-value="#b2b200"
                                                style="background-color: rgb(178, 178, 0);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item" data-value="#006100"
                                                ...
                                                style="background-color: rgb(107, 36, 178);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item" data-value="#444444"
                                                ...
                                                style="background-color: rgb(102, 102, 0);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item" data-value="#003700"
                                        ...
                                        <option value="#3d1466"></option>
                                            ...
                                            tabindex="-1" id="ql-picker-options-1"><span tabindex="0" role="button"
                                                ...
                                                role="button" class="ql-picker-item ql-primary" data-value="#9933ff"
                                                style="background-color: rgb(153, 51, 255);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item"></span><span tabindex="0"
                                                role="button" class="ql-picker-item" data-value="#facccc"
                                                style="background-color: rgb(250, 204, 204);"></span><span tabindex="0"
                                                role="button" class="ql-picker-item" data-value="#ffebcc"
                                                style="background-color: rgb(255, 235, 204);"></span><span tabindex="0"
                                        ...
                                        <option value="#002966"></option>
                                        <option value="#3d1466"></option>
                                    </select></span><span class="ql-formats"><span class="ql-size ql-picker"><span
                                            class="ql-picker-label" tabindex="0" role="button" aria-expanded="false"
                                            aria-controls="ql-picker-options-2"><svg viewBox="0 0 18 18">
                                                <polygon class="ql-stroke" points="7 11 9 13 11 11 7 11"></polygon>
                                                <polygon class="ql-stroke" points="7 7 9 5 11 7 7 7"></polygon>
                                            </svg></span><span class="ql-picker-options" aria-hidden="true"
                                            tabindex="-1" id="ql-picker-options-2"><span tabindex="0" role="button"
                                        ...
                                        <option value="huge"></option>
                                            ...
                                            class="ql-picker-label" tabindex="0" role="button" aria-expanded="false"
                                            aria-controls="ql-picker-options-3"><svg viewBox="0 0 18 18">
                                                <polygon class="ql-stroke" points="7 11 9 13 11 11 7 11"></polygon>
                                                <polygon class="ql-stroke" points="7 7 9 5 11 7 7 7"></polygon>
                                            </svg></span><span class="ql-picker-options" aria-hidden="true"
                                            tabindex="-1" id="ql-picker-options-3"><span tabindex="0" role="button"
                                        ...
                                        <option selected="selected"></option>
                                    </select></span><span class="ql-formats"><button type="button" class="ql-link"
                                        aria-pressed="false" aria-label="link"><svg viewBox="0 0 18 18">
                            ...
                            <div class="quill-contact h-200px ql-container ql-snow">
        ...
        <div class="d-flex flex-wrap flex-stack my-6">
            <h3 class="fw-bold my-2" data-lang="Quick chat messages">Tin nhắn nhanh</h3>
            <div class="d-flex flex-wrap my-2">
                <button class="btn btn-primary btn-sm" data-lang="button::Update"
                    onclick="_settings.on.click.updateQuickReply()">Cập nhật</button>
            </div>
        </div>
        <div class="row g-6" id="support">
            <div class="col-lg-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="text-end">
                            <button type="button" class="btn btn-sm btn-outline btn-outline-primary btn-icon"
                                onclick="_settings.on.click.addQuickReply()"><i class="la la-plus fs-3"></i></button>
                        </div>
                    </div>
                </div>
            </div>

            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                <div class="w-lg-500px p-10">
                    ...
                    <?php if(session('error')): ?>
                        <div class="alert alert-danger mb-5"><?php echo e(session('error')); ?></div>
                    <?php endif; ?>
                    <?php if(session('success')): ?>
                        <div class="alert alert-success mb-5"><?php echo e(session('success')); ?></div>
                    <?php endif; ?>

                    <form method="POST" action="<?php echo e(route('login.store')); ?>" class="form w-100">
                        <?php echo csrf_field(); ?>

                        <div class="text-center mb-11">
                            <h1 class="text-dark fw-bolder mb-3">Sign in</h1>
                            <div class="text-gray-500 fw-semibold fs-6"><?php echo e(config('app.name')); ?></div>
                        </div>
                        ...
                        <div class="fv-row mb-8">
                            <input type="text" name="username" value="<?php echo e(old('username')); ?>"
                                class="form-control form-control-solid <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-gray-500 text-center fw-semibold fs-6">
                            Not a Member yet?
                            <a href="<?php echo e(route('signup')); ?>" class="link-primary">Sign up</a>
                        </div>
                    </form>
...
<?php /**PATH C:\xampp\htdocs\resources\views/clients/theme-4/auth/signin.blade.php ENDPATH**/ ?>